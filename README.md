Sistema RH Center 🖥️
O RH Center é uma aplicação de linha de comando desenvolvida em Python para facilitar o gerenciamento de funcionários em pequenas empresas. O sistema permite o cadastro de novos colaboradores, a persistência de dados em arquivos CSV e a geração de relatórios estatísticos.
